...
public class SupportPreferenceFragmentManager {

	private static final String TAG = SupportPreferenceFragmentManager.class.getSimpleName();
	 ...
	 */
	static void setFragment(PreferenceManager manager, BaseSupportPreferenceFragment fragment) {
		// stub
	}
